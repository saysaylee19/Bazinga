...
public class DynamicGridViewDemo extends Activity implements   View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		global_panel.setBackgroundDrawable(getResources().getDrawable( R.drawable.item2));
		...
		*/
		...
		String texts[] = new String[]{"Facebook", "camera", "phone","email", 
				"sms", "appstore"}; 
		...
		for (int i=0;i<6;i++) {
			DynGridViewItemData item = new DynGridViewItemData( 
					...
					250, 250, 15, // sizes: item w, item h, item padding
